...
function DoInstall()
{
  ...
  $APPLICATION->IncludeAdminFile("Установка модуля test_module ", $DOCUMENT_ROOT."/bitrix/modules/test/install/step.php");
}
...
function DoUninstall()
{
  ...
  $APPLICATION->IncludeAdminFile("Деинсталляция модуля test_module", $DOCUMENT_ROOT."/bitrix/modules/test/install/unstep.php");
}
}
?>